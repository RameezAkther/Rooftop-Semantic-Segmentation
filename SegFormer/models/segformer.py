...
@register_model
def make_SegFormerB0(num_classes, **kwargs):
    model = Segformer(num_classes=num_classes, **kwargs)
    return model


@register_model
def make_SegFormerB1(num_classes, **kwargs):
    dims = (64, 128, 320, 512)
    decoder_dim = 512
    model = Segformer(dims=dims, decoder_dim=decoder_dim,
                      num_classes=num_classes, **kwargs)
    return model


@register_model
def make_SegFormerB2(num_classes, **kwargs):
    dims = (64, 128, 320, 512)
    num_layers = (3, 3, 6, 3)
    decoder_dim = 512
    model = Segformer(dims=dims, num_layers=num_layers, decoder_dim=decoder_dim,
                      num_classes=num_classes, **kwargs)
    return model


@register_model
def make_SegFormerB3(num_classes, **kwargs):
    dims = (64, 128, 320, 512)
    num_layers = (3, 3, 18, 3)
    decoder_dim = 512
    model = Segformer(dims=dims, num_layers=num_layers, decoder_dim=decoder_dim,
...
@register_model
def make_SegFormerB4(num_classes, **kwargs):
    dims = (64, 128, 320, 512)
    num_layers = (3, 8, 27, 3)
    decoder_dim = 512
    model = Segformer(dims=dims, num_layers=num_layers, decoder_dim=decoder_dim,
...
@register_model
def make_SegFormerB5(num_classes, **kwargs):
    dims = (64, 128, 320, 512)
    ff_expansion = (4, 4, 4, 4)
    num_layers = (3, 6, 40, 3)
    decoder_dim = 512
    model = Segformer(dims=dims, ff_expansion=ff_expansion, num_layers=num_layers,
                      decoder_dim=decoder_dim, num_classes=num_classes, **kwargs)
    return model